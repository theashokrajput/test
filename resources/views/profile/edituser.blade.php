                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('profile.update', $profile->id ) }}" method="POST"  enctype="multipart/form-data" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="name" class="form-control" name="name" value="{{ old('name', $profile->name) }}" required autofocus>
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="pin_code" class="form-control" name="pin_code" required
                                            autofocus>
